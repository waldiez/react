...
export class RetrieveConfigData {
    ...
    private static getTask(json: { [key: string]: any }) {
        ...
        if (
            ...
            ["code", "qa", "default"].includes(json.task)
        ) {
    ...
    private static getDbConfigConnectionUrl(json: { [key: string]: any }) {
        ...
        if (
            "connectionUrl" in json &&
            typeof json.connectionUrl === "string" &&
            json.connectionUrl.length > 0
        ) {
    ...
    private static getCustomTextTypes(json: { [key: string]: any }) {
        ...
        if (
            "customTextTypes" in json &&
            Array.isArray(json.customTextTypes) &&
            json.customTextTypes.length > 0
        ) {
