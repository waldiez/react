...
export class WaldiezSourceUserProxyOrAssistant implements IWaldiezSourceUserProxyOrAssistant {
    ...
    asNode(position?: XYPosition): WaldiezNodeUserProxyOrAssistant {
        ...
        if (position) {
            ...
            if (
                typeof this.rest.position === "object" &&
                "x" in this.rest.position &&
                "y" in this.rest.position
            ) {
    ...
    static fromJSON = (
        ...
        const agentDescription = WaldiezSourceUserProxyOrAssistant.getAgentDescription(
            agentNodeType,
            jsonObject,
        );
