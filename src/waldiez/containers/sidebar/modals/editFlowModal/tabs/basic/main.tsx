        ...
        <div className="modal-body agent-panel agent-config-panel" id={`rf-${flowId}-edit-flow-modal`}>
            ...
            {edgesCount === 0 ? (
                ...
                <div className="flow-chat-order-wrapper">
                    <div className="info">
                        Specify the chats to run when the flow initializes and their order (if more than one).
                        You should remove the ones that are expected to be triggered during the flow (like in
                        nested chats).
                    </div>
                        ...
                        return (
                            <div key={edge.id} className="flow-order-item-wrapper">
                                <div className="flow-order-item">
                                    <span className="flow-order-item-entry">
