import { InfoCheckbox, InfoLabel } from '@waldiez/components/inputs';
import { RagUserAgentConfigTabAdvancedViewProps } from '@waldiez/components/nodes/agent/modal/tabs/ragUser/tabs/advanced/types';

export const RagUserAgentConfigTabAdvancedView = (props: RagUserAgentConfigTabAdvancedViewProps) => {
  const {
    id,
    data,
