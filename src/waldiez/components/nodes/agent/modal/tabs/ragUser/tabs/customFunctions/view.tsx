...
import { RagUserAgentConfigTabCustomFunctionsViewProps } from '@waldiez/components/nodes/agent/modal/tabs/ragUser/tabs/customFunctions/types';
import { TabItem, TabItems } from '@waldiez/components/tabs';

export const RagUserAgentConfigTabCustomFunctionsView = (
  props: RagUserAgentConfigTabCustomFunctionsViewProps
) => {
  const {
    id,
    flowId,
  ...
  return (
    <TabItems activeTabIndex={0}>
      <TabItem label="Embedding" id={`wf-${flowId}-agent-ragUser-${id}-customFunctions-embedding`}>
        <div className="flex-column">
          <InfoCheckbox
            ...
            dataTestId="rag-use-custom-embedding"
          />
      ...
      <TabItem label="Token Count" id={`wf-${flowId}-agent-ragUser-${id}-customFunctions-tokenCount`}>
        <div className="flex-column">
          <InfoCheckbox
            ...
            dataTestId="rag-use-custom-tokenCount"
          />
      ...
      <TabItem label="Text Split" id={`wf-${flowId}-agent-ragUser-${id}-customFunctions-textSplit`}>
        <div className="flex-column">
          <InfoCheckbox
            ...
            dataTestId="rag-use-custom-textSplit"
          />
