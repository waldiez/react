...
import { useWaldiezAgentTermination } from '@waldiez/components/nodes/agent/modal/tabs/termination/hooks';
import { WaldiezAgentTerminationProps } from '@waldiez/components/nodes/agent/modal/tabs/termination/types';
