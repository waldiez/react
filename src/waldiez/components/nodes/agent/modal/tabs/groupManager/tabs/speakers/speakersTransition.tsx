...
import { SpeakerTransitionsType, WaldiezNodeGroupManagerData } from "@waldiez/models";
        ...
        <div className="padding-10">
            ...
            <Select
                ...
                value={{
                    ...
                    value: data.speakers?.transitionsType as SpeakerTransitionsType,
                }}
...
const speakerTransitionOptions: { label: string; value: SpeakerTransitionsType }[] = [
