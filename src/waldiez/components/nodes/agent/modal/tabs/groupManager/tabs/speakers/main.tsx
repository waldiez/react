...
import { useGroupManagerSpeakers } from '@waldiez/components/nodes/agent/modal/tabs/groupManager/tabs/speakers/hooks';
import { GroupManagerSpeakersTransition } from '@waldiez/components/nodes/agent/modal/tabs/groupManager/tabs/speakers/speakersTransition';
import {
  WaldiezAgentNode,
    ...
    info={() => (
      <>
        ...
        <ul>
          ...
          <li>
            <strong>"Custom Method"</strong>: A customized speaker selection function (Callable): the function
            will be called to select the next speaker. The function should take the last speaker and the group
            chat as input and return one of the following:
            <ul>
              <li>an Agent class, it must be one of the agents in the group chat.</li>
              <li>
                a string from ['auto', 'manual', 'random', 'round_robin'] to select a default method to use.
              </li>
