...
import { useWaldiezAgentBasic } from '@waldiez/components/nodes/agent/modal/tabs/basic/hooks';
import { WaldiezAgentBasicProps } from '@waldiez/components/nodes/agent/modal/tabs/basic/types';
