...
import { useWaldiezAgentGroup } from '@waldiez/components/nodes/agent/modal/tabs/group/hooks';
import { WaldiezAgentGroupProps } from '@waldiez/components/nodes/agent/modal/tabs/group/types';

export const WaldiezAgentGroup = (props: WaldiezAgentGroupProps) => {
  const { id } = props;
  const { groupOptions, currentGroupManager, selectedGroup, onSelectGroupChange, onJoinGroup, onLeaveGroup } =
