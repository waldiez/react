...
import { useWaldiezAgentSkills } from '@waldiez/components/nodes/agent/modal/tabs/skills/hooks';
...
export const WaldiezAgentSkills = (props: WaldiezAgentSkillsProps) => {
  ...
  return (
    <div className="agent-panel agent-skills-panel">
      {skills.length === 0 ? (
        <div className="agent-no-skills margin-top-10 margin-bottom-10">No skills found in the workspace</div>
      ) : (
        <div>
